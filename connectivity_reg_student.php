...
//ONLY FOR THE CREATION OF THE DATABASE.....
	...
	$sql = "CREATE DATABASE Simple_login";
...
//INSERTION INTO THE TABLE....
	...
	//	$sql = "INSERT INTO Login(userName, pass) VALUES('d/15/cs/110','abhishek')";
		...
		if(!$conn)
		{
			...
			{//checking the 'user' name which is from Sign_In.html, is it empty or have some text...
				...
				if(!empty($row['userName']) AND !empty($row['pass']))
				{
					...
					header('Location: http://localhost/web%20technology%20project/NoDuesForm_CourseAdvisor.html');
				}	
				else
				{
